/**
 * Your App Config Should Look like this. Follow these steps
 * (1) Create a "duplicate" of this file in the same folder and rename it to 'app-config.js'
 * (2) In your new app-config.js file, replace the <placeholder> strings with your appropriate values
 * (3) Thats all there is to it :P
 */
(function () {
    $(document).ready(function () {
        ...
        var config = {
            appDevUrl: '<Your APP Dev Url>',
            fayeDevUrl: '<Your App Dev Url>/faye',
            env: 'dev',
            apiEndPoints: {
            ...
            firebaseCacheKey: '<Your Firebase localStorage Key> i.e. firebase:session::<you-firebase-name>',
            firebaseAuthCallbacks: [],
            tunneling: false,
            tempSecureTunnel: '<Tunneling url to test facebook posts - see https://ngrok.com/'>,   
